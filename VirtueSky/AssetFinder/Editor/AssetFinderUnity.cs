...
namespace VirtueSky.AssetFinder.Editor
{
    public class AssetFinderUnity
    {
        ...
        public static void SplitPath(string assetPath, out string assetName,
            out string assetExtension, out string assetFolder)
        {
            ...
            assetExtension = (lastDot > lastSlash && lastDot > 0)
                ? assetPath.Substring(lastDot, assetPath.Length - lastDot).ToLower()
                : string.Empty;
 ...
 typeof(Selection).GetProperty("assetGUIDs", BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static);
        ...
        public static readonly Dictionary<int, string> HashClassesNormal =
        ...
        public static void GetCompilingPhase(string path, out bool isPlugin, out bool isEditor)
        {
            ...
            {
                bool isPluginEditor =
                    path.StartsWith("Assets/Plugins/Editor/", StringComparison.Ordinal)
        ...
        {
            return (int)(time.ToUniversalTime() -
        ...
        {
            bool v1 = GUILayout.Toggle(v, label, EditorStyles.toolbarButton,
        ...
        internal static void ExportSelection()
        {
            ...
            FieldInfo fieldInfo =
                packageExportT.GetField(prop, BindingFlags.NonPublic | BindingFlags.Instance);
            if (fieldInfo == null)
            {
            ...
            MethodInfo methodInfo =
                packageExportT.GetMethod("BuildAssetList",
        ...
        public static int ReplaceTerrainTextureDatas(TerrainData terrain, Texture2D fromObj,
            Texture2D toObj)
        {
            var found = 0;
#if UNITY_2018_3_OR_NEWER
