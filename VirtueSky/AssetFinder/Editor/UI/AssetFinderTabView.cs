...
namespace VirtueSky.AssetFinder.Editor
{
    ...
    public class AssetFinderTabView
    {
        public int current;
        ...
        public static AssetFinderTabView FromEnum(Type enumType, IWindow w,
            bool canDeselectAll = false)
        {
            ...
            return new AssetFinderTabView(w, canDeselectAll)
                { current = 0, labels = labels.ToArray() };
        }
        ...
        public static AssetFinderTabView Create(IWindow w, bool canDeselectAll = false,
            params object[] titles)
        {
            var labels = new List<GUIContent>();
