...
{
    public class AssetFinderTreeUI2
    {
        ...
        public class GroupDrawer : Drawer
        {
                ...
                Action<List<string>> customGroupSort = null)
            {
                ...
                if (tree == null)
                {
                    tree = new AssetFinderTreeUI2(this);
                }
            ...
            {
                get { return tree != null && tree.rootItem.childCount > 0; }
            }
            ...
            internal void Draw(ref int index, ref Rect rect, int minY, int maxY)
            {
                ...
                if (height > 0 && (interMin || interMax))
                {
                    ...
                    if (index % 2 == 1 && AssetFinderSetting.AlternateRowColor)
                    {
                        ...
                        GUI.DrawTexture(
                            new Rect(rect.x - AssetFinderSetting.TreeIndent, rect.y, rect.width,
                                rect.height),
                    ...
                    if (childCount > 0)
                    {
                        IsOpen = GUI.Toggle(new Rect(rect.x + x - 16f, rect.y, 16f, 16f), IsOpen,
                            string.Empty,
