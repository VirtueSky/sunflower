    ...
    public static class GUI2
    {
        ...
        public static UnityEngine.Object[] DropZone(string title, float w, float h)
        {
            ...
            GUI2.Color(
                () =>
                {
                    GUI.DrawTexture(plusRect, AssetFinderIcon.Plus.image, ScaleMode.ScaleToFit);
...
//        }
        ...
        public static bool Toggle(ref bool value, string label, GUIStyle style,
        ...
        public static bool Toggle(ref bool value, Texture2D tex, GUIStyle style,
            params GUILayoutOption[] options)
        {
        ...
        public static bool Toggle(ref bool value, GUIContent tex, GUIStyle style,
            params GUILayoutOption[] options)
        {
            var vv = GUILayout.Toggle(value, tex, style, options);
            if (vv == value) return false;
        ...
        internal static Dictionary<string, GUIContent> tooltipCache =
        ...
        internal static bool ToolbarToggle(ref bool value, Texture icon, Vector2 padding,
            string tooltip = null)
        {
            var vv = GUILayout.Toggle(value, GetTooltip(tooltip), EditorStyles.toolbarButton,
                GUILayout.Width(22f));
        ...
        public static bool EnumPopup<T>(ref T mode, string label, float labelWidth, GUIStyle style,
            params GUILayoutOption[] options)
        {
        ...
        public static bool EnumPopup<T>(ref T mode, GUIContent icon, GUIStyle style,
            params GUILayoutOption[] options)
        {
            var obj = (Enum)(object)mode;
        ...
        public static GUIStyle miniLabelAlignRight
        {
            get
            {
                return _miniLabelAlignRight ?? (
                    _miniLabelAlignRight = new GUIStyle(EditorStyles.miniLabel)
