...
namespace VirtueSky.AssetFinder.Editor
{
    public partial class AssetUsageDetector
    {
        ...
        {
            get { return Application.dataPath + "/../Library/AssetUsageDetector.cache"; }
            ...
            if (assetDependencyCache == null)
            {
                ...
                if (allAssets.Length > 0)
                {
                    ...
                    try
                    {
                        ...
                        {
                            if (i % 30 == 0 && EditorUtility.DisplayCancelableProgressBar("Please wait...", "Generating cache for the first time (optional)",
