...
namespace qtools.qhierarchy.pdata
{
    ...
    public class QSettings
    {
        ...
        public QComponentsOrderList componentsOrderList;
        ...
        private Dictionary<int, QSettingChangedHandler> settingChangedHandlerList =
            new Dictionary<int, QSettingChangedHandler>();
        ...
        private QSettings()
        {
            ...
            {
                settingsObject = (QSettingsObject)AssetDatabase.LoadAssetAtPath(AssetDatabase.GUIDToAssetPath(paths[i]),
                    typeof(QSettingsObject));
