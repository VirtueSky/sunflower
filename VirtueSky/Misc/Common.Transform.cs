...
namespace VirtueSky.Misc
{
    public static partial class Common
    {
            ...
            Action completed = null)
        {
            ...
            transformObj.ScaleTo(targetBounceX, time / 3, easingTypes, false, TweenRepeat.Once,
                () =>
                {
                    transformObj.ScaleTo(targetBounceY, time / 3, easingTypes, false, TweenRepeat.Once,
                        () => { transformObj.ScaleTo(baseScale, time / 3, easingTypes, false, TweenRepeat.Once, completed); });
                });
        }
